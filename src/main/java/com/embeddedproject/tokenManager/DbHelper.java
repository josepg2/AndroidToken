...
class DbHelper extends SQLiteOpenHelper {
    ...
    void insertTokenDetail(TokenData tokenData) {
        ...
        try {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    tokenData.tokenStatus = cursor.getInt(cursor.getColumnIndex(STATUS)) == 1;
    ...
    List<TokenData> getUnAttentedTokens() {
    ...
    void updateTokenStatus (int tokenNumber, boolean tokenStatus) {
        SQLiteDatabase db = getWritableDatabase();
    ...
    boolean getTokenStatus (int tokenNumber){
